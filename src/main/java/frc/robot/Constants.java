 ...
 * wherever the constants are needed, to reduce verbosity. (<em>statically</em>,
 * Anthony)
 */
public final class Constants {
    ...
    public static class XboxMap implements AuxGamepadMap {
        ...
        public int intakeSpit() {
            return 4;
        }

        public int smartShoot() {
            return 3;
        }

        public int shootReverse() {
            return 6;
        }
    ...
    public static final class LimelightConstants {
        ...
        public static final double limelightMountAngle = 0.0; // TODO: set limelight mount angle
    }
    ...
    public static final class UltrasonicSensorConstants {
         ...
         * multiply
         */
        public static double voltsToCm = 1 / 9.77;
        public static double cmToIn = 1 / 2.54;
    }
}